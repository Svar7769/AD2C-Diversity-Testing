"""
Runner script for Buzz Wire task with ESC control.
...
CONFIG_NAME = "buzz_wire_ippo_config"
SAVE_PATH = "/home/svarp/Desktop/Projects/ad2c - testEnv/model_checkpoint/buzz_wire_ippo/"
...
TASK_OVERRIDES = {
    # Add any specific buzz_wire parameters here if needed
}
...
if __name__ == "__main__":
    ...
    if USE_ESC and ESC_OVERRIDES:
        try:
            ...
            # Save to a task-specific temporary file to avoid collision
            temp_esc_config = "/tmp/escontroller_buzz_wire.yaml"
    ...
    print(f"{'='*80}")
    print(f"🎯 Running Buzz Wire Task")
    print(f"{'='*80}\n")
