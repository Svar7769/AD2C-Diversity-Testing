...
def setup(task_name):
    ...
    if task_name == "vmas/buzz_wire":   #vmas/navigation
...
CONFIG_NAME = "buzz_wire_ippo_config"  # Make sure 'navigation_ippo.yaml' exists in the folder above!
SAVE_PATH = "/home/spatel/Desktop/ad2c/model_checkpoint/buzz_wire_ippo/"
