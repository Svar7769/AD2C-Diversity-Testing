...
def setup(task_name):
    ...
    if task_name == "vmas/reverse_transport":   #vmas/navigation
...
CONFIG_NAME = "reverse_transport_ippo_config"  # Make sure 'navigation_ippo.yaml' exists in the folder above!
SAVE_PATH = "/home/spatel/Desktop/ad2c/model_checkpoint/reverse_transport_ippo/"
