"""
Runner script for Reverse Transport task with ESC control.
...
CONFIG_NAME = "reverse_transport_ippo_config"
SAVE_PATH = "/home/svarp/Desktop/Projects/ad2c - testEnv/model_checkpoint/reverse_transport_ippo/"
...
TASK_OVERRIDES = {
    # Add any specific reverse_transport parameters here if needed
}
...
if __name__ == "__main__":
    ...
    if USE_ESC and ESC_OVERRIDES:
        try:
            ...
            temp_esc_config = "/tmp/escontroller_reverse_transport.yaml"
    ...
    print(f"{'='*80}")
    print(f"🎯 Running Reverse Transport Task")
    print(f"{'='*80}\n")
