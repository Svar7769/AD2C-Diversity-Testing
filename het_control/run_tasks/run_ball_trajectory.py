...
def setup(task_name):
    ...
    if task_name == "vmas/ball_trajectory":   #vmas/navigation
...
CONFIG_NAME = "ball_trajectory_ippo_config"  # Make sure 'navigation_ippo.yaml' exists in the folder above!
SAVE_PATH = "/home/spatel/Desktop/ad2c/model_checkpoint/ball_trajectory_ippo/"
