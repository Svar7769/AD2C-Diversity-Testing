"""
Runner script for Ball Passage task with ESC control.
Updated with the new system path: /home/svarp/Desktop/Projects/ad2c - testEnv/
"""
...
CONFIG_NAME = "ball_passage_ippo_config"
SAVE_PATH = "/home/svarp/Desktop/Projects/ad2c - testEnv/model_checkpoint/ball_passage_ippo/"

# Training parameters
MAX_FRAMES = 1_200_000
CHECKPOINT_INTERVAL = 1_200_000

# Initial SND (matching your original -1.0 value)
DESIRED_SND = -1.0

# Task-specific overrides
TASK_OVERRIDES = {
    # Add any specific ball_passage parameters here if needed
}
...
if __name__ == "__main__":
    ...
    if USE_ESC and ESC_OVERRIDES:
        try:
            ...
            temp_esc_config = "/tmp/escontroller_ball_passage.yaml"
    ...
    print(f"{'='*80}")
    print(f"🎯 Running Ball Passage Task (New System Path)")
    print(f"{'='*80}\n")
    
    # Execute via the reusable run_experiment function
    run_experiment(
