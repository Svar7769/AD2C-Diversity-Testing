...
def setup(task_name):
    ...
    if task_name == "vmas/sampling":   #vmas/navigation
...
CONFIG_NAME = "sampling_ippo_config"  # Make sure 'navigation_ippo.yaml' exists in the folder above!
SAVE_PATH = "/home/spatel/Desktop/ad2c/model_checkpoint/sampling_ippo/"
